...
ImageManager.clear = function() { //Nel Replace
  for (var p in this._cache) {

     if (this._cache.hasOwnProperty(p) && this._cache[p] instanceof Bitmap) {
      if (this._cache[p].baseTexture) this._cache[p].baseTexture.destroy();
     }
  }
  this._cache = {};
};
